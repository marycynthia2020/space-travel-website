...
const Crew = () => {
  ...
  return (
    <div className="min-h-screen overflow-hidden bg-crewMobile md:bg-crewTablet xl:bg-crewDesktop bg-no-repeat bg-center bg-cover pb-4 ">
      <Navbar />
      ...
      <div className="w-[90%]  md:w-4/5 mx-auto flex flex-col items-center xl:flex-row">
        <div className="flex flex-col items-center xl:w-1/2 ">
          ...
          <p className="text-lg md:text-2xl xl:text-[32px]  md:mb-6 xl:self-start font-bellefair">{crew.role}</p>
          <h2 className="text-2xl md:text-[40px] xl:text-[56px] mb-4 md:mb-6 xl:self-start font-bellefair">{crew.name}</h2>
          <p className="text-[15px] md:text-[16px] mb-20 xl:mb-32 text-center xl:self-start xl:text-left font-barlow leading-loose md:w-3/4 xl:w-[90%]">
            {crew.bio}
          </p>
         <CrewTabs />
        </div>
